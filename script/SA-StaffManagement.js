...
function showDeleteConfirmation(id) {
    Swal.fire({
        title: 'ARE YOU SURE?',
        text: 'Do you really want to delete this admin / staff? Process cannot be undone.',
        icon: null,
...
function showSuspendConfirmation(id) {
    Swal.fire({
        title: 'ARE YOU SURE YOU WANT TO SUSPEND THIS ADMIN/STAFF?',
        ...
        icon: null,
        iconHtml: '<div style="background-color: white; padding: 30px; "><img <img src="../../images/icons8-warning-100.png" style="width: 90px;">',
        showCancelButton: true,
        cancelButtonText: 'CANCEL',
        cancelButtonColor: '#e3e6e9',
        confirmButtonColor: '#711717',
