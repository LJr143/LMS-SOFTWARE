...
<body>
    ...
    <!--weekly, monthly and quarterly members-->
    <main>
                    ...
                    <div class="wrapper d-flex justify-content-center mt-0">
                        ...
                        <div class="totalU p-4 bg-white shadow mb-2 custom-container">
                            <div class="circle-container">
                                <img src="../images/daily-visitors.png" alt="Icon" style="width: 60px;">
                            </div>
                            <h4 class="text-center mt-2" style="font-weight: bold; color: darkred">91</h4>
                            <h6 class="text-center" style="font-size: 14px;">Weekly New Members</h6>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wrapper d-flex justify-content-center mt-0">
                        ...
                        <div class="totalR p-4 bg-white shadow mb-2 custom-container">
                            <div class="circle-container2">
                                <img src="../images/monthly-visitor.webp" alt="Icon" style="width: 60px;">
                            </div>
                            <h4 class="text-center mt-2" style="font-weight: bold; color: darkred">151</h4>
                            <h6 class="text-center" style="font-size: 14px;">Monthly New Members</h6>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wrapper d-flex justify-content-center mt-0">
                        <div class="totalI p-4 bg-white shadow mb-2 custom-container">
                            <div class="circle-container3">
                                <img src="../images/total-visitor.png" alt="Icon" style="width: 50px; ">
                            </div>
                            <div class="text-container">
                                <h4 class="text-center mt-2" style="font-weight: bold; color: darkred">671</h4>
                                <h6 class="text-center" style="font-size: 14px;">Quarterly Total New Members</h6>
                            </div>
                        </div>
                    </div>
                </div>
