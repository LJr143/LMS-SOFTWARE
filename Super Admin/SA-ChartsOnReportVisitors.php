...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-between ">
        ...
        <div class="col-md-2 mb-1   ">
          <a href="#"> <img src="excel.png" alt="Excel photo" style="width: 50px;"></a>
        </div>
      </div>
    </div>
  </main>
  ...
  <main>
    ...
    <!--weekly, monthly and quarterly visitors-->
    <div class="container-fluid">
      <div class="row justify-content-center">
          ...
          <div class="wrapper d-flex justify-content-center mt-0">
            ...
            <div class="totalU p-4 bg-white shadow mb-2 custom-container">
              <div class="circle-container">
                <img src="daily-visitors.png" alt="Icon" style="width: 60px;">
              </div>
              <h4 class="text-center mt-2" style="font-weight: bold; color: darkred">161</h4>
              <h6 class="text-center" style="font-size: 14px;">Daily Visitors</h6>
            </div>
          </div>
        </div>
          ...
          <div class="wrapper d-flex justify-content-center mt-0">
            ...
            <div class="totalR p-4 bg-white shadow mb-2 custom-container">
              <div class="circle-container2">
                <img src="monthly-visitor.webp" alt="Icon" style="width: 60px;">
              </div>
              <h4 class="text-center mt-2" style="font-weight: bold; color: darkred">521</h4>
              <h6 class="text-center" style="font-size: 14px;">Monthly Visitors</h6>
            </div>
          </div>
        </div>
          ...
          <div class="wrapper d-flex justify-content-center mt-0">
            <div class="totalI p-4 bg-white shadow mb-2 custom-container">
              <div class="circle-container3">
                <img src="total-visitor.png" alt="Icon" style="width: 50px; ">
              </div>
              <div class="text-container">
                <h4 class="text-center mt-2" style="font-weight: bold; color: darkred">921</h4>
                <h6 class="text-center" style="font-size: 14px;">Quarterly Total Visitors</h6>
              </div>
            </div>
          </div>
